                ...
                <table className='w-full'>
                    ...
                    <tbody>
                        {Array.from({ length: 8}).map((_, i) => {
                            ...
                            <td className='py-3 px-4 text-sm'>12743</td>
                            <td className='py-3 px-4 text-sm'>
                    ...
                    <tfoot>
                        <tr>
                            <td colSpan={3} className='py-3 px-4 tex-zinc-300'>
                                Mostrando 8 de 228 itens
                            </td>
                            <td colSpan={3} className='py-3 px-4 tex-zinc-300 text-right'>
